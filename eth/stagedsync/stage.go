...
type ExecFunc func(firstCycle bool, badBlockUnwind bool, s *StageState, unwinder Unwinder, tx kv.RwTx, commitAfterEachStage bool, quiet bool) (ForwardResult, error)
